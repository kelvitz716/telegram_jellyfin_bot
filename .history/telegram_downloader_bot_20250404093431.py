...
async def handle_media(message):
    ...
    if not media_group_id:
        ...
        if media_group_id in self.download_manager.batch_trackers:
            ...
            # Check if this file is already in the batch (by file_id)
            ...
            # Update the batch message with the correct count
            try:
                await self.bot.edit_message_text(
                    chat_id=batch_tracker.chat_id,
                    message_id=batch_tracker.message_id,
            ...
            # First file in this media group
            # Mark this media group as pending
            ...
            batch_tracker = BatchProgressTracker(
                ...
                total_files=0,  # Start at 0, we'll increment for each file
                batch_id=media_group_id,
                rate_limiter=self.download_manager.rate_limiter
            )
            batch_tracker.files = []  # Initialize empty files list
        ...
        # Store file in the batch data if not already there
