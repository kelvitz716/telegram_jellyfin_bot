    ...
    def _setup_handlers(self):
        ...
        def handle_media(message):
            ...
            download_thread = threading.Thread(
                ...
                args=(file_id, file_path, message.chat.id, progress_message.message_id)
            )
            download_thread.daemon = True
            download_thread.start()
    
    def _download_file(self, file_id, file_path, chat_id, message_id):
        ...
        try:
            ...
            # If file is large (>20MB), get direct URL for chunked download
            ...
            if success:
                ...
                download_stats["total_bytes"] += os.path.getsize(file_path)
