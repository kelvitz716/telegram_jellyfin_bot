...
API_ID = 12345  # Your Telegram API ID (get from my.telegram.org)
API_HASH = "your_api_hash_here"  # Your Telegram API hash (get from my.telegram.org)
...
def main() -> None:
    ...
    # Set up pre-run and shutdown handlers for Telethon
    application.pre_run = initialize_telethon
    application.post_stop = shutdown_telethon
