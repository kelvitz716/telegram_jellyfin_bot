    ...
    def _setup_handlers(self) -> None:
        ...
        A modular, asynchronous Telegram downloader for media files with support for
            ...
            if not media_group_id:
                ...
                # Check if we've already scheduled this media group for processing
                if media_group_id in self.download_manager.pending_media_groups:
                    logger.debug(f"Media group {media_group_id} already pending, appending file")
...
class ConfigManager:
    ...
    def _load_or_create_config(self) -> Dict[str, Any]:
        """
        Load configuration from file or create default if it doesnt exist.
