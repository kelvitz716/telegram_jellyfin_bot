...
# Configuration
CONFIG_FILE = "media_watcher_config.json"
DEFAULT_CONFIG = {
    "paths": {
...
def main():
    ...
    handler = FileEventHandler(categorizer)
    notifier = pyinotify.Notifier(wm, handler)
    
    # Add watch on download directory
    wdd = wm.add_watch(categorizer.download_dir, mask, rec=True, auto_add=True)
