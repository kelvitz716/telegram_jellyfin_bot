...
class MediaCategorizer:
    ...
    def _setup_directories(self):
        ...
        # Use Path for correct cross-platform path handling
        home_dir = str(Path.home())
        base_dir = os.path.join(home_dir, "telegram-jellyfin-bot")
        
        # Override paths with user home directory
        self.download_dir = os.path.join(base_dir, "downloads")
        self.movies_dir = os.path.join(base_dir, "movies")
        self.tv_shows_dir = os.path.join(base_dir, "tvshows") 
        self.unmatched_dir = os.path.join(base_dir, "unmatched")
