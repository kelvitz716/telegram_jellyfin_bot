...
class TelegramDownloader:
    ...
    def _setup_telethon(self):
        ...
        try:
            ...
            # Create a session file path in the current working directory with proper permissions
            session_file = os.path.join(os.getcwd(), "telegram_bot_session.session")
