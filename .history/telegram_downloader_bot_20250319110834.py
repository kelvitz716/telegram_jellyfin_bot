...
class TelegramDownloader:
    def __init__(self, config_path: str = CONFIG_FILE):
        ...
        self.bot_token = self.config["telegram"]["YOUR_BOT_TOKEN"]
        self.api_id = self.config["telegram"]["YOUR_API_ID"]
        self.api_hash = self.config["telegram"]["YOUR_API_HASH"]
    ...
    def _setup_handlers(self):
        ...
        def handle_media(message):
            ...
            download_thread = threading.Thread(
                ...
                args=(file_id, file_path, message.chat.id, progress_message.message_id, message)
            )
    ...
    def _download_file(self, file_id, file_path, chat_id, message_id, original_message=None):
        ...
        try:
            ...
            use_telethon = self.client is not None and file_size > 20 * 1024 * 1024 and original_message
            ...
            while retries <= self.max_retries and not success:
                try:
                    ...
                    if use_telethon:
                        logger.info(f"Using Telethon for large file download: {file_path}")
                        ...
                        logger.info(f"Using Bot API for download: {file_path}")
