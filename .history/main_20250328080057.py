...
from telethon.errors import NetworkMigrateError, FloodWaitError, 
import tqdm
    ...
    async def _download_media_with_tqdm(self, event, download_path, status_message):
        ...
        async def rate_limited_download():
            ...
            for attempt in range(max_retries):
                ...
                except NetworkMtuError:
                    # Adjust MTU and retry
                    self.logger.warning("Network MTU error, adjusting...")
