...
from downloader import MultiSourceDownloader, TelegramMediaDownloader
...
class MediaManagerApp:
    ...
    def __init__(
        ...
        self.categorizer = MediaCategorizer(
            base_dir=self.config_manager.get('paths', 'download_dir', '~/Downloads')
        )
